...
<head>
    ...
    <title>สมัครสมาชิกช่าง • TechFix.it</title>
...
<body>
    <div class="wrap">
        <div class="card">
            <div class="brand">
                <h1 class="title-grad">สมัครสมาชิกช่าง</h1>
            </div>
            ...
            <form method="post" action="register_process.php">
                <div class="field">
                    ...
                    <div class="input">
                        <input id="fullname" name="fullname" type="text" placeholder="ชื่อ-สกุล" required autofocus>
                    </div>
                </div>

                <div class="field">
                    <label class="sr-only" for="username">ชื่อผู้ใช้ (สำหรับ Login)</label>
                    <div class="input">
                        <input id="username" name="username" type="text" placeholder="ชื่อผู้ใช้ (สำหรับ Login)" required>
                    </div>
                </div>
                ...
                <div class="field">
                    <label class="sr-only" for="password_confirm">ยืนยันรหัสผ่าน</label>
                    <div class="input">
                        <input id="password_confirm" name="password_confirm" type="password" placeholder="ยืนยันรหัสผ่าน" required>
                    </div>
                </div>
            ...
            <div class="foot">
                มีบัญชีอยู่แล้ว? <a href="technician_login.php">เข้าสู่ระบบที่นี่</a>
            </div>
        </div>
    </div>
</body>
