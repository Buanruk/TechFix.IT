...
<head>
  ...
  <title>เข้าสู่ระบบแอดมิน • TechFix.it</title>
  ...
  <div class="wrap">
    <div class="card">
      <div class="brand">
        ...
        <h1 class="title-grad">เข้าสู่ระบบแอดมิน</h1>
      </div>
      ...
      <form method="post" action="admin_login_process.php" autocomplete="off" novalidate>
